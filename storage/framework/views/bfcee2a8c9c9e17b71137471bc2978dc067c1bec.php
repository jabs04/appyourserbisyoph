...
<?php $component->withAttributes([]); ?>
    <div class="container-fluid">
        <div class="row">
            <?php if($rezorpayX_details ==null): ?>
            <div class="col-md-12">
                <div class="alert alert-warning py-3">
                    <p class="h6"><i class="fas fa-info-circle mr-2"></i><?php echo e(__('messages.info_message')); ?>

                        <a href="<?php echo e(route('setting.index')); ?>" target="_blank" class="ml-1 text-primary"> <?php echo e(__('messages.here_is_the_link')); ?><i class="fas fa-external-link-alt"></i></a>
                    </p>
                </div>
            </div>
            <?php endif; ?>
            <div class="col-md-12">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_booking']) ? $data['dashboard']['count_total_booking']: 0); ?> </h4>
                                                <!-- <h4 class="mb-2 booking-text  font-weight-bold text-break"> 000000000000 </h4> -->
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.bookings')])); ?></p>
                                        </div>
                            ...
                            <div class="card total-service-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_service']) ? $data['dashboard']['count_total_service'] : 0); ?></h4>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.services')])); ?></p>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a  href="<?php echo e(route('provider.index')); ?>">
                            <div class="card total-provider-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_provider']) ? $data['dashboard']['count_total_provider'] : 0); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.providers')])); ?></p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                            ...
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(getPriceFormat(round($data['total_revenue']))); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.revenue')])); ?></p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <h4 class=""><?php echo e(__('messages.monthly_revenue')); ?></h4>
                        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card top-providers">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4 class="font-weight-bold"><?php echo e(__('messages.recent_provider')); ?></h4>
                            <a href="<?php echo e(route('provider.index')); ?>" class="btn-link btn-link-hover"><u><?php echo e(__('messages.view_all')); ?> </u></a>
                    </div>
                            ...
                            <li style="pointer-events:none;">
                                <div class="media gap-3">
                                    <div class="h-avatar is-medium h-5">
                                        <img class="avatar-50 rounded-circle bg-light" alt="user-icon" src="<?php echo e(getSingleMedia($provider,'profile_image', null)); ?>">
                                    </div>
                                    
                                    <div class="media-body ">
                                        <h5><span class="font-weight-bold"><?php echo e(!empty($provider->display_name) ? $provider->display_name : '-'); ?></span> </h5>
                                            <span class="common-list_rating d-flex gap-1">
                                                <i class="ri-star-s-fill"></i>
                                                <?php echo e(round($provider->getServiceRating->avg('rating'), 1)); ?>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card top-providers">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4 class="font-weight-bold"><?php echo e(__('messages.recent_customer')); ?></h4>
                        <a href="<?php echo e(route('user.index')); ?>" class="btn-link btn-link-hover"><u><?php echo e(__('messages.view_all')); ?></u></a>
                    </div>
                    <div class="card-body p-0">
                        <ul class="common-list list-unstyled">
                            ...
                            <li style="pointer-events:none;">
                                <div class="media gap-3">
                                    <div class="h-avatar is-medium h-5">
                                        <img class="avatar-50 rounded-circle bg-light" alt="user-icon" src="<?php echo e(getSingleMedia($customer,'profile_image', null)); ?>">
                                    </div>
                                    <div class="media-body ">
                                        <h5><span class="font-weight-bold"><?php echo e(!empty($customer->display_name) ? $customer->display_name : '-'); ?></span>  </h5>
                                        <span><?php echo e(optional($datetime)->date_format && optional($datetime)->time_format
        ...
        : ''); ?></span>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card recent-activities">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4><?php echo e(__('messages.recent_booking')); ?></h4>
                        <a href="<?php echo e(route('booking.index')); ?>" class="btn-link btn-link-hover"><u><?php echo e(__('messages.view_all')); ?></u></a>
                    </div>
                        <div class="card-body">
                                ...
                                <?php $__currentLoopData = $data['dashboard']['upcomming_booking']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="d-flex flex-wrap gap-2 align-items-start align-items-lg-center justify-content-between flex-column flex-lg-row "  style="pointer-events:none;">
                                        <div class="media align-items-center gap-3">
                                                <div class="h-avatar is-medium h-5">
                                                    <img class="avatar-50 rounded-circle bg-light" alt="user-icon" src="<?php echo e(getSingleMedia($booking->customer,'profile_image', null)); ?>">
                                                </div>
                                                <div class="media-body ">
                                                    <h5>#<?php echo e($booking->id); ?></h5>
                                                    <span><?php echo e(optional($datetime)->date_format && optional($datetime)->time_format
        ...
        : ''); ?></span>    
                                        ...
                                        <span class="badge rounded-pill py-2 px-3 badge-pending text-capitalize"><?php echo e($booking->status); ?></span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
<script>
    ...
    if(jQuery('#monthly-revenue').length){
        ...
        series: [{
            name: 'revenue',
            data: [ <?php echo e(implode ( ',' ,$data['revenueData'] )); ?> ]
...
</script><?php /**PATH C:\xampp\htdocs\appyourserbisyoph\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>