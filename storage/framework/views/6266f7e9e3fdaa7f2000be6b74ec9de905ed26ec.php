          ...
          <div class="row align-items-center">
             <div class="col-lg-6 col-md-7">
                <ul class="top-header-left list-inline d-flex align-items-center gap-3 m-0">
                   <li>
                        ...
                        ?>
                      <a class="text-white d-flex align-items-center" href="tel:<?php echo e(optional($appsetting)->helpline_number); ?>">
                         ...
                         <span><?php echo e(optional($appsetting)->helpline_number); ?></span>
                      </a>
                   </li>
                </ul>
             </div>
             <div class="col-lg-6 col-md-5 text-md-end">
                <div class="d-inline-block">
                  ...
                  <?php if($sectionData['enable_language'] == 1): ?>
                     ...
                     <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <?php $__currentLoopData = $language_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <a class="dropdown-item d-block" href="<?php echo e(route('switch-language',['locale'=> $lang['id'] ])); ?>">
       ...
       <div class="container-fluid navbar-inner">
          <div class="d-flex align-items-center justify-content-between w-100 landing-header">
             <div class="d-flex gap-3 gap-xl-0 align-items-center">
                ...
                <!--Logo -->
                <?php echo $__env->make('landing-page.components.widgets.header_logo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
             </div>
             <!-- navigation -->
             <?php echo $__env->make('landing-page.partials._horizontal-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
             ...
             <div class="right-panel">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   <ul class="navbar-nav align-items-center ms-auto mb-2 mb-xl-0 p-0">
                     ...
                     <?php if($sectionData && isset($sectionData['header_setting']) && $sectionData['header_setting'] == 1): ?>
                     <?php if($sectionData['enable_darknight_mode'] == 1): ?>
                     ...
                     <?php endif; ?>
                      ...
                      <?php if(auth()->check() && auth()->user()->user_type == 'user'): ?>
                        <li class="nav-item">
                           <a href="<?php echo e(route('favourite.service')); ?>" class="nav-link" id="wishlist">
                      ...
                      <?php endif; ?>
                      <!-- Wishlist -->
                      <?php if(empty(auth()->user()) || auth()->user()->user_type !== 'user'): ?>
                        <li class="ms-sm-3 ms-2">
                           <a href="<?php echo e(route('user.login')); ?>" class="btn btn btn-outline-primary" role="button">
                              ...
                              <a class="nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                                 ...
                                 <div class="icon-50">
                                    <span class="btn-inner d-inline-block position-relative">
                                       <img src="<?php echo e(getSingleMedia(auth()->user(),'profile_image')); ?>"
                              ...
                              <ul class="dropdown-menu dropdown-menu-end user-dropdown-menu p-0"
                                 ...
                                 <li>
                                    <a class="dropdown-item" href="<?php echo e(route('home')); ?>">
                                       ...
                                       <span class="ms-2"> <?php echo e(__('messages.dashboard')); ?></span>
                                    </a>
                                 </li>
                                 ...
                                 <li>
                                    <span class="dropdown-item">
                                       ...
                                       <span class="ms-2">
                                          ...
                                          <span class="text-primary"><?php echo e(getPriceFormat($wallet_amount)); ?></span>
                                       </span>
                                    </span>
                                 </li>
                                 ...
                                 <li>
                                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                                       ...
                                       <a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault();
                                          ...
                                          <span class="ms-2"> <?php echo e(__('messages.logout')); ?></span>
                                       </a>
                                    </form>
                                 </li>
                              </ul>
...
<?php /**PATH C:\xampp\htdocs\appyourserbisyoph\resources\views/landing-page/partials/_header.blade.php ENDPATH**/ ?>