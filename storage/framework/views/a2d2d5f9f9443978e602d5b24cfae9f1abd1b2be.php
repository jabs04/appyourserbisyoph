...
(function($) {
    ...
    $(document).ready(function(){
        ...
        function confirmation(form,title = "<?php echo e(__('messages.confirmation')); ?>",message = "<?php echo e(__('messages.delete_msg')); ?>",ajaxtype=false,_this){
            $.confirm({
            content: message,
            type: '',
            title: title,
...
<?php /**PATH C:\xampp\htdocs\appyourserbisyoph\resources\views/partials/_dynamic_script.blade.php ENDPATH**/ ?>