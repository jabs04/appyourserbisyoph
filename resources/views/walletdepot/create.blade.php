...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="card card-block card-stretch">
                <div class="card-body p-0">
                    ...
                    <h5 class="font-weight-bold">{{ $pageTitle ?? __('messages.list') }}</h5>
                                <a href="{{ route('walletdepot.index') }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                {{ Form::model($wallet,['method' => 'POST','route'=>'walletdepot.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'wallet'] ) }}
                    {{ Form::hidden('id') }}
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select('user_id', [ optional($wallet->providers)->id => optional($wallet->providers)->display_name ], optional($wallet->providers)->id, [
                                        ...
                                        'id' => 'user_id',
                                        'required',
                                        'data-placeholder' => __('messages.select_name',[ 'select' => __('Depot') ]),
                                        'data-ajax--url' => route('ajax-list', ['type' => 'depot-user']),
                                ]) }}                       
