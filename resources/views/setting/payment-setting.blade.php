...
<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-tabs pay-tabs nav-fill tabslink" id="tab-text" role="tablist">
            ...
            <li class="nav-item payment-link">
                <a href="javascript:void(0)" data-href="{{ route('payment_layout_page') }}?tabpage=maya" data-target=".payment_paste_here" data-toggle="tabajax"  class="nav-link  {{$tabpage=='maya'?'active':''}}"   rel="tooltip"> {{__('messages.maya')}}</a>
            </li>
