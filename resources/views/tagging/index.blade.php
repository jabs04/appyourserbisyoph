...
<head>
              ...
              <div class="d-flex justify-content-end">
                <div class="datatable-filter ml-auto">
                  <select name="column_status" id="column_status" class="select2 form-control" data-filter="select" style="width: 100%">
                    ...
                    <option value="provider" {{$filter['status'] == 'provider' ? "selected" : ''}}>Provider</option>
                    <option value="Neopreneur" {{$filter['status'] == 'Neopreneur' ? "selected" : ''}}>Neopreneur</option>
                  </select>
                </div>
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("tag.tag_data_table",["list_status" => $list_status]) }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
